...
### Column Aliases
If you want to assign your own lables other than the auto-generated ones or name the columns generated by the result of an expression/function, you can add a column alias after each element of your SELECT clause. A good example is the previous select statement-- `language_usage`, `lang_pi_value`, and `language_name` are all aliases. It makes the output easier to read and easier to interact with programmatically. If you want to make the aliases stand out as aliases, you can use the AS keyword (although you don't have to)
```
...
```
If you think it improves readability, go ahead and include it. If not, feel free not to.
### Removing Duplicates
